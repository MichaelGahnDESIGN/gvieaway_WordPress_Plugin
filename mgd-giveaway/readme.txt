...
= 0.0.34 =
* E-Mail-Vorschau im Formular-Backend ergänzt.

= 0.0.33 =
* E-Mail-Design im Formular-Backend anpassbar gemacht.

= 0.0.32 =
* Bestätigungs- und Download-E-Mails als gebrandete HTML-E-Mails im Stil der Website gestaltet.

= 0.0.31 =
* Datenschutz-URL beim Speichern stabilisiert und Popup-Ausgabe strikt an die eingetragene URL gebunden.

= 0.0.30 =
* Rekursives Formular-Rendering im Datenschutz-Popup verhindert.

= 0.0.29 =
* Absenden-Button per Formular-ID fest mit dem Formular verknüpft, damit Submit auch bei Elementor-DOM-Korrekturen funktioniert.

= 0.0.28 =
* Absenden-Button mit Inline-Abstand und direktem Submit-Fallback abgesichert.

= 0.0.27 =
* Abstand über dem Absenden-Button vergrößert.

= 0.0.26 =
* Frontend-Absenden per JavaScript-Fallback robuster gemacht und sichtbare Fehlermeldung ergänzt.

= 0.0.25 =
* Formularspeicherung, Feldnamen, E-Mail-Validierung, Mail-Filter und Token-Gültigkeit robuster gemacht.
...
* Felder können per Klick oder Drag & Drop aus der Palette hinzugefügt und im Canvas sortiert werden.
